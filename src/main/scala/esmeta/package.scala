...
val POLYFILL_LOG_DIR = s"$LOG_DIR/polyfill/dump"
val POLYFILL_OUT_DIR = s"$LOG_DIR/polyfill/minipoly"
...
val POLYFILL_RESOURCE_DIR = s"$RESOURCE_DIR/polyfill"
val POLYFILL_RULES_DIR = s"$POLYFILL_RESOURCE_DIR/rules"
val POLYFILL_RUNTIME_DIR = s"$POLYFILL_RESOURCE_DIR/runtime"
